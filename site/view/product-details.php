                ...
                <div class="col-md-6">
                    <div class="product-images">
                        <div class="main-image">
                            <img src="../public/img/sp-1.webp" alt="Sữa Chống Nắng So-ri Vitamin C"
                                id="mainProductImage" />
                            <div class="image-nav">
                        ...
                        <div class="thumbnail-images">
                            <div class="thumbnail active">
                                <img src="../public/img/sp-1.webp" alt="Thumbnail 1" />
                            </div>
                            <div class="thumbnail">
                                <img src="../public/img/sp-2.webp" alt="Thumbnail 2" />
                            </div>
                            <div class="thumbnail">
                                <img src="../public/img/sp-3.webp" alt="Thumbnail 3" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="product-info">
                        ...
                        <div class="product-price">
                            <span class="current-price">335.000đ</span>
        ...
        <div class="product-container">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="product-item">
                        <div class="product-image">
                            <img src="../public/img/sp-1.webp" alt="Sữa Chống Nắng Rau Má Kiềm Dầu SPF 50+ PA+++H" />
                        </div>
                        <div class="product-details">
                            <h3 class="product-name">
                ...
                <div class="col-md-3">
                    <div class="product-item">
                        <div class="product-image">
                            <img src="../public/img/sp-1.webp" alt="Kem Chống Nắng Vật Lý Tone-up SPF 50+ SPF 50+" />
                        </div>
                        <div class="product-details">
                            <h3 class="product-name">
